 ...
 */
Ext.define('AM.view.booking.DateTimeField', {
    extend: 'Ext.form.FieldContainer',
    alias: 'widget.am.datetimefield',
...
// this.onFieldChange('time', 'start'); // << use case
    onFieldChange: function(type, startend){
		// preventing strange case where startValue > endValue 
		// 
    ...
    // private
		// it will prevent strange case where startValue > endValue 
