Ext.define('AM.view.accounting.transactionactivityentry.Form', {
  extend: 'Ext.window.Window',
  alias : 'widget.transactionactivityentryform',
...
// if autoShow == true.. on instantiation, will automatically be called 
  ...
  initComponent: function() {
		...
		var remoteJsonStoreAccount = Ext.create(Ext.data.JsonStore, {
			storeId : 'transaction_ledger_account_search',
			fields	: [
			 				{
						name : 'account_name',
						mapping : "name"
    ...
    this.items = [{
      ...
      items: [
	        ...
	        fieldLabel: 'Amount'
				...
				{
					xtype: 'checkbox',
					name : 'is_bank_transaction',
					fieldLabel: 'Transaksi Bank?'
				},
