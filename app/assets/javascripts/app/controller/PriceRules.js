Ext.define('AM.controller.PriceRules', {
  extend: 'Ext.app.Controller',

  stores: ['PriceRules', 'Facilities'],
  models: ['PriceRule'],

  views: [
    'master.pricerule.List',
    'master.pricerule.Form',
  ...
  init: function() {
    this.control({
      ...
      'priceruleform button[action=save]': {
        click: this.updateObject
      },

	 
      'pricerulelist button[action=addObject]': {
        click: this.addObject
      },

			'pricerulelist button[action=repeatObject]': {
        click: this.addObject
      },


      'pricerulelist button[action=editObject]': {
        click: this.editObject
      },
      'pricerulelist button[action=deleteObject]': {
  ...
  updateObject: function(button) {
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			var newObject = new AM.model.PriceRule( values ) ;
